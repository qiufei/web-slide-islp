...
![Credit data: RSS and $R^2$ for all possible models. The red frontier tracks the best model for each number of predictors.](figures/6_1.png)
...
![C<sub>p</sub>, BIC, and adjusted R<sup>2</sup> for the best models of each size on the *Credit* data.](figures/6_2.png)
...
![BIC, validation set error, and cross-validation error for the best models of each size on the *Credit* data.](figures/6_3.png)
...
![Standardized ridge regression coefficients for the *Credit* data, as a function of λ and ||β<sup>λ</sup><sub>R</sub>||<sub>2</sub> / ||β||<sub>2</sub>.](figures/6_4.png)
...
![Squared bias, variance, and test MSE for ridge regression on a simulated dataset.](figures/6_5.png)
...
![Standardized lasso coefficients for the *Credit* data, as a function of λ and ||β<sup>λ</sup><sub>L</sub>||<sub>1</sub> / ||β||<sub>1</sub>.](figures/6_6.png)
...
![Contours of the error and constraint functions for the lasso (left) and ridge regression (right).](figures/6_7.png)
...
::: {layout-ncol=2}
![Lasso and ridge regression on a simulated dataset where *all* predictors are related to the response.](figures/6_8.png)
...
![Lasso and ridge regression on a simulated dataset where only *two* predictors are related to the response.](figures/6_9.png)
...
::: {layout-ncol=2}
![Ridge and lasso coefficient estimates in the simple case.](figures/6_10.png)
...
![Cross-validation error and coefficient estimates for ridge regression on the *Credit* data.](figures/6_12.png)
...
::: {layout-ncol=2}
![Cross-validation error and coefficient estimates for the lasso on the simulated data from Figure 6.9.](figures/6_13.png)
...
![Population size and ad spending for 100 cities. The first principal component is shown in green, and the second in blue.](figures/6_14.png)
...
::: {layout-ncol=2}
![The first principal component direction, with distances to the observations shown as dashed lines.](figures/6_15.png)
...
![Plots of the first principal component scores versus pop and ad.](figures/6_16.png)
...
![Plots of the *second* principal component scores versus pop and ad.](figures/6_17.png)
...
![PCR applied to two simulated datasets.](figures/6_18.png)
...
![PCR, ridge regression, and the lasso on a simulated dataset where the first five principal components of X contain all the information about the response Y.](figures/6_19.png)
...
![PCR standardized coefficient estimates and cross-validation MSE on the *Credit* data.](figures/6_20.png)
...
![First PLS direction (solid line) and first PCR direction (dotted line) for the advertising data.](figures/6_21.png)
...
![The lasso performed with varying numbers of features (p) and a fixed sample size (n).](figures/6_24.png)
