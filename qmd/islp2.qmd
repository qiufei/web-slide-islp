...
::: {style="font-size: 0.75em;"}
![Advertising Data: Sales vs. Advertising Budgets](figures/2_1.png){width=80%}
...
::: {style="font-size: 0.8em;"}
![Income vs. Years of Education](figures/2_2.png){width=80%}
...
![Linear Model Fit](figures/2_4.png){width=70%}
...
::: {style="font-size: 0.7em;"}
![Thin-Plate Spline Fit](figures/2_5.png){width=60%}
...
::: {style="font-size: 0.7em;"}
![Rough Spline Fit](figures/2_6.png){width=60%}
...
::: {style="font-size: 0.8em;"}
![Cluster Analysis Example](figures/2_8.png){width=70%}
...
::: {style="font-size: 0.7em;"}
![MSE vs. Flexibility](figures/2_9.png){width=70%}
...
::: {style="font-size: 0.7em;"}
![Bias-Variance Trade-Off](figures/2_12.png){width=90%}
...
::: {style="font-size: 0.7em;"}
![Bayes Classifier Example](figures/2_13.png){width=60%}
...
::: {style="font-size: 0.7em;"}
![KNN Example](figures/2_14.png){width=70%}
