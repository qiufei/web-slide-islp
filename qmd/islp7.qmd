...
![Continuous Piecewise Cubic](figures/7_3_2.png){width=80%}

![Cubic Spline. Continuous, first and second contiuous derivatives](figures/7_3_3.png){width=80%}
:::
...
![Linear Spline](figures/7_3_4.png)
